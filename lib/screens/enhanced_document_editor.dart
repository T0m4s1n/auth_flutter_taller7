...
class EnhancedDocumentEditorScreen extends StatefulWidget {
  final RiverDocument document;
  final VoidCallback onDocumentUpdated;

  const EnhancedDocumentEditorScreen({
    super.key,
  ...
  @override
  State<EnhancedDocumentEditorScreen> createState() => _EnhancedDocumentEditorScreenState();
}

class _EnhancedDocumentEditorScreenState extends State<EnhancedDocumentEditorScreen>
  ...
  Future<void> _applyAISuggestion(AISuggestion suggestion) async {
    ...
    try {
      ...
      switch (suggestion.command) {
        case 'mejorar':
          prompt = 'Mejora la gramática, estilo y claridad del siguiente texto:';
          break;
        case 'expandir':
          prompt = 'Expande y desarrolla más el siguiente contenido:';
          break;
        case 'buscar':
          prompt = 'Busca información relevante y actualizada sobre el siguiente tema:';
          break;
        case 'citas':
          prompt = 'Agrega citas, referencias y fuentes para el siguiente contenido:';
          break;
        case 'estructura':
          prompt = 'Reorganiza y estructura mejor el siguiente contenido:';
          break;
        case 'resumir':
          prompt = 'Crea un resumen conciso del siguiente contenido:';
          break;
      }
